...
SelecionarLoteDeEntrada.addEventListener('click', ()=>{
    ...
    iniciarProcesso.addEventListener('click', async (e)=>{
        ...
        await process.criaProcesso('higienizacao', id, false, quantidade, extrativistas, locais, 'copaiba');

        let container = document.querySelector('[data-container]');
        container.innerHTML = ''
        //deve ser inicializado com a materia prima em questão//
        process.listarProcessosPendentes('copaiba');
